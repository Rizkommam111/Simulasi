                ...
                <div class="p-6 text-gray-900">
                    <div>
                        <form wire:submit="update">
                            <!-- nama_barang -->
                            <div>
                                <x-input-label for="id_inventaris" :value="__('Id Inventaris')" />
                                <select wire:model.live="id_inventaris" id="id_inventaris" class="block mt-1 w-full" type="select" nama_barang="nama_barang" required autofocus autocomplete="nama_barang" >
